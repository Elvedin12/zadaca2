 ...
 */
            ...
            for (int i = 0; i <= granice; i++) {
                ...
                for (int j = 0; j < rijec.length(); j++) {
                    ...
                    // Dodati brojac kad je rijec nadjena
                    else {
                        broj_rijeci ++;
                    }
            ...
            // u ispis staviti varijablu "rijec" i varijablu "broj_rijeci" da bi vidjeli koliko se puta ponavlja.
            String message = sadrzi ? "Rečenica sadrži riječ " + rijec + " " +  broj_rijeci + " puta" : "Rečenica NE sadrži riječ";
